...
public class SanPhamChiTietRepository {
    ...
    public ArrayList<SanPhamChiTietRespone> getAll() {
        String sql = "	SELECT \n"
                ...
                + "    dbo.SanPhamChiTiet \n"
                + "INNER JOIN \n"
                + "    dbo.SanPham ON dbo.SanPhamChiTiet.id_san_pham = dbo.SanPham.id\n"
                + "INNER JOIN \n"
                + "    dbo.ThuongHieu ON dbo.SanPhamChiTiet.id_thuong_hieu = dbo.ThuongHieu.id \n"
                + "INNER JOIN \n"
                + "    dbo.XuatXu ON dbo.SanPhamChiTiet.id_xuat_xu = dbo.XuatXu.id \n"
                + "INNER JOIN \n"
                + "    dbo.MauSac ON dbo.SanPhamChiTiet.id_mau_sac = dbo.MauSac.id \n"
                + "INNER JOIN \n"
                + "    dbo.KichThuoc ON dbo.SanPhamChiTiet.id_kich_thuoc = dbo.KichThuoc.id \n"
                + "INNER JOIN \n"
                + "    dbo.ChatLieu ON dbo.SanPhamChiTiet.id_chat_lieu = dbo.ChatLieu.id \n"
                + "INNER JOIN \n"
                + "    dbo.CoAo ON dbo.SanPhamChiTiet.id_co_ao = dbo.CoAo.id \n"
                + "INNER JOIN \n"
                + "    dbo.DoDay ON dbo.SanPhamChiTiet.id_do_day = dbo.DoDay.id \n"
                + "INNER JOIN \n"
                + "    dbo.TinhLinhHoat ON dbo.SanPhamChiTiet.id_tinh_linh_hoat = dbo.TinhLinhHoat.id \n"
                + "WHERE \n"
                + "    dbo.SanPhamChiTiet.trang_thai_ban= 1;";
    ...
    public ArrayList<SanPhamChiTietRespone> locTheoDieuKien(String tenChatLieu, String tenXuatXu, String tenThuongHieu, boolean sapXepGiaBan) {
        ...
        String sql = "SELECT  \n"
                ...
                + "WHERE \n"
                + "    dbo.SanPhamChiTiet.trang_thai_ban = 1\n"
                + "    AND dbo.ChatLieu.ten_chat_lieu LIKE ?\n"
    ...
    public ArrayList<SanPhamChiTietRespone> getSanPhamChiTietByIdSanPham(int idSanPham) {
        String sql = "SELECT \n"
                ...
                + "WHERE \n"
                + "    dbo.SanPhamChiTiet.trang_thai_ban = 1 \n"
                + "    AND dbo.SanPham.id = ?;"; // Lọc theo id_san_pham
    ...
    public SanPhamChiTietRespone getSanPhamChiTietByMaSPCT(String maSPCT) {
        String sql = "SELECT \n"
                ...
                + "WHERE \n"
                + "    dbo.SanPhamChiTiet.trang_thai_ban = 1 \n"
                + "    AND dbo.SanPhamChiTiet.ma_san_pham_chi_tiet = ?;";
